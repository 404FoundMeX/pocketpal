...
export default function TermsOfServicePage() {
  return (
    <main className="from-black-900 to-black-100 min-h-screen bg-gradient-to-b text-white">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-8 text-xl text-gray-300 sm:text-2xl">
            Please read these terms carefully before using PocketPal. By using
          ...
          <div className="flex justify-center">
            <Chip
              size="lg"
              variant="flat"
              className="border border-blue-500/30 bg-blue-500/20 text-blue-400"
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed text-gray-300">
                PocketPal is a financial management application that helps users
                track expenses, manage budgets, and achieve financial goals. We
                offer both hosted and self-hosted versions of our service.
              </p>
              <p className="text-lg leading-relaxed text-gray-300">
                These terms govern your use of our hosted service, website, and
                any related services. For self-hosted deployments, these terms
                apply to the software license and support services.
              </p>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="text-center text-gray-300">
                  You must be at least 18 years old to use our service, or have
                  parental consent if you are between 13-17 years old.
                </p>
              </CardBody>
            </Card>
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="text-center text-gray-300">
                  Our service is available worldwide, subject to local laws and
                  regulations that may restrict financial services.
                </p>
              </CardBody>
            </Card>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Use real, accurate information when creating your account
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Keep your login credentials secure and notify us of any
                      unauthorized access
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Use our service in compliance with all applicable laws and
                      regulations
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Don&apos;t use our service for illegal activities or to harm
                      others
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Don&apos;t attempt to reverse engineer or hack our systems
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Don&apos;t send spam or abuse our communication systems
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="container mx-auto rounded-t-lg bg-gray-800/30 px-4 py-16">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-12 text-center text-4xl font-bold">
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  PocketPal is a financial management tool, not a financial
                  advisor. The information provided through our service is for
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  ...
                  100% uptime. Our service may be temporarily unavailable due to
      ...
      <section className="container mx-auto bg-gray-800/30 px-4 py-16">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-12 text-center text-4xl font-bold">
            Data & Privacy
          </h2>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-4 text-center">
              ...
              <p className="text-gray-300">
                You retain ownership of all data you input into our service. We
                only process it to provide our services to you.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto rounded-b-lg bg-gray-800/30 px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-12 text-center text-4xl font-bold">
          ...
          <div className="space-y-8">
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  PocketPal is released under the MIT License, which means you
                  are free to use, modify, and distribute the software, subject
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  We retain rights to our trademarks, service marks, and other
                  proprietary materials. The PocketPal name and logo are our
                  intellectual property.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-gray-300">
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  ...
                  terms, engage in fraudulent activity, or for other legitimate
                  business reasons.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-gray-300">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
                <CardBody className="text-center">
                  ...
                  <h3 className="mb-2 font-semibold">Notification</h3>
              ...
              <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
                <CardBody className="text-center">
                  ...
                  <h3 className="mb-2 font-semibold">Effective Date</h3>
                  <p className="mb-4 text-sm text-gray-300">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-8 text-3xl font-bold">
            Questions & Legal Information
          </h2>
          <div className="space-y-6">
            <p className="text-lg text-gray-300">
              If you have questions about these terms or need legal
              clarification,               please don&apos;t hesitate to reach out. We&apos;re here to
              help ensure you understand your rights and obligations.
            </p>
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="rounded-lg border border-gray-700 bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              ...
              PocketPal. By using our service, you acknowledge that you have
