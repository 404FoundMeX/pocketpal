      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-8 text-xl text-gray-300 sm:text-2xl">
            Your privacy is our priority. Learn how PocketPal protects your
            financial data and maintains complete transparency in our data
            practices.
          </p>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed text-gray-300">
                At PocketPal, we believe that financial privacy is a fundamental
                human right. We&apos;ve built this application from the ground up
                with privacy-first principles, offering both a hosted version
                for convenience and the ability to self-host for complete
                control.
              </p>
              <p className="text-lg leading-relaxed text-gray-300">
                This privacy policy explains how we handle your information,
                what data we collect, and most importantly, what we don&apos;t do
                ...
                <div className="h-96 w-80 rounded-2xl bg-gradient-to-br from-green-600 via-blue-600 to-purple-600 p-8">
                  <div className="flex h-full items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <h3 className="mb-2 text-2xl font-bold">Privacy First</h3>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="text-center text-gray-300">
                  ...
                  end-to-end encryption, or you can choose to self-host for
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="text-center text-gray-300">
                  We don&apos;t track your usage, collect analytics, or monitor your
                  behavior. Your financial activities remain completely private.
                </p>
              </CardBody>
            </Card>
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="text-center text-gray-300">
                  Our entire codebase is open source, so you can verify exactly
                  how we handle your data and even modify it if needed.
                </p>
              </CardBody>
            </Card>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  Use our hosted version for convenience and accessibility. Your
                  data is stored securely on our servers with enterprise-grade
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  Deploy your own instance for complete control and privacy. All
                  data stays on your infrastructure with no external
                  dependencies.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-gray-300">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Basic account details like email and username for
                      authentication
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Your expenses, budgets, and financial goals (stored
                      securely on our servers or locally if self-hosted)
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Settings and customization options you choose
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      No real names, addresses, or personal identification
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      No access to your actual bank accounts or credentials
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      No tracking of how you use the application
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-4 text-center">
              ...
              <p className="text-gray-300">
                Data is stored on secure, encrypted servers with
            ...
            <div className="space-y-4 text-center">
              ...
              <p className="text-gray-300">
                Data is encrypted both at rest and in transit using
            ...
            <div className="space-y-4 text-center">
              ...
              <p className="text-gray-300">
                You have complete control over your data and can delete it at
                any time
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              ...
              <CardBody>
                <p className="mb-4 text-gray-300">
                  PocketPal is committed to never sharing, selling, or renting
                  your personal information to third parties. Your financial
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              <CardBody className="text-center">
                ...
                <h3 className="mb-2 text-lg font-semibold">Right to Access</h3>
                <p className="text-sm text-gray-300">
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              <CardBody className="text-center">
                ...
                <h3 className="mb-2 text-lg font-semibold">Right to Export</h3>
                <p className="text-sm text-gray-300">
            ...
            <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
              <CardBody className="text-center">
                <div className="mx-auto mb-4 w-fit rounded-full bg-red-500/20 p-3">
                  <XCircle className="h-6 w-6 text-red-400" />
                </div>
                <h3 className="mb-2 text-lg font-semibold">Right to Delete</h3>
                <p className="text-sm text-gray-300">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="space-y-6">
            <p className="text-lg text-gray-300">
              ...
              handle your data,               please don&apos;t hesitate to reach out. We&apos;re
              committed to transparency and will always be honest about our data
              practices.
            </p>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <Card className="border border-gray-700 bg-gray-800/50 backdrop-blur-sm">
                <CardBody className="text-center">
                  ...
                  <Link
                    href="/contact"
                    className="text-[hsl(280,100%,70%)] transition-colors hover:text-[hsl(280,100%,60%)]"
                  >
                    Get in Touch →
                  </Link>
                </CardBody>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-4xl text-center">
          <div className="rounded-lg border border-gray-700 bg-gray-800/50 p-6">
            ...
            <p className="text-gray-300">
              This privacy policy applies to PocketPal as both a hosted service
              and an open-source project. You can use our hosted version for
              convenience or deploy your own instance for complete control over
