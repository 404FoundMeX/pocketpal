    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Manage your finances in minutes, not spreadsheets"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        >
          With AI-powered insights and complete privacy control, you can master
          your money in minutes, not hours. Try our open-source, self-hosted
          financial companion that keeps your data yours.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
