...
export function Pricing({
  ...
  const handleToggle = (checked: boolean) => {
    ...
    if (checked && switchRef.current) {
      ...
      (confetti as (options: { particleCount: number; spread: number; origin: { x: number; y: number }; colors: string[]; ticks: number; gravity: number; decay: number; startVelocity: number; shapes: string[] }) => void)({
        particleCount: 50,
        spread: 60,
        origin: {
