          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="grid">
                ...
                <p className="text-sm">{session?.user.email ?? "user@example.com"}</p>
              </div>
            </div>
            <EditUserDialog />
          </div>
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              onCheckedChange={(checked: boolean | "indeterminate") =>
                checked === true ? setSignOutDevices(true) : setSignOutDevices(false)
              }
            />
      ...
      <DialogContent className="w-11/12 sm:max-w-[425px]">
        ...
        {data?.length ? (
          <Table>
            ...
            <TableBody>
              {data.map((passkey: { id: string; name?: string }) => (
                <TableRow
                  key={passkey.id}
